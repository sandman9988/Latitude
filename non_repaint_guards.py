...
class NonRepaintBarAccess:
    ...
    def safe_get_previous(self, bars_ago: int) -> Optional[float]:
        """
    ...
    def __repr__(self) -> str:
        return (f"NonRepaintBarAccess(name={self.name}, bars={len(self.data)}, "
...
class NonRepaintIndicator:
    ...
    def get_previous(self, bars_ago: int) -> Optional[float]:
...
if __name__ == "__main__":
    ...
    if val == 101.0:
        ...
        print(f"    ERROR: Expected 101.0, got {val}")
        sys.exit(1)
    ...
    if val == 102.0:
        ...
        print(f"    ERROR: Expected 102.0, got {val}")
        sys.exit(1)
    ...
    try:
        ...
        print(f"    ERROR: Should have raised NonRepaintError")
        sys.exit(1)
    except NonRepaintError as e:
