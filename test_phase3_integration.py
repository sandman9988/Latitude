...
def test_dual_agent_attribution():
    ...
    print(f"✓ Trade 1 recorded")
    print(f"  Predicted runway: 95 pips | Actual MFE: 100 pips (1.05x = EXCELLENT)")
    print(f"  Capture: 72% (GOOD) | MFE at bar 8, exited 7 bars later")
    print()
    ...
    print(f"  Capture: -13% (POOR_WTL) | Held 23 bars after MFE peak")
    print()
    ...
    print(f"✓ Trade 3 recorded")
    print(f"  Predicted runway: 75 pips | Actual MFE: 100 pips (1.33x = GOOD)")
    print(f"  Capture: 88% (EXCELLENT) | Exited only 4 bars after MFE peak")
    print()
