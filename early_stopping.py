...
class EarlyStopping:
    ...
    def __call__(self, current_value: float, current_weights: Optional[Dict] = None) -> bool:
        """
        ...
        if improved:
            ...
            LOG.info(
                ...
                current_value, abs(current_value - self.best_value)
            )
            ...
            LOG.debug(
                ...
                current_value, self.best_value, self.wait_count, self.patience
            )
            ...
            if self.wait_count >= self.patience:
                ...
                LOG.warning(
                    ...
                    self.patience, self.best_value, self.best_epoch
                )
                return True
