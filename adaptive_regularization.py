...
class AdaptiveRegularization:
    ...
    def __init__(
        ...
        LOG.info(
            ...
            initial_l2, self.l2_min, self.l2_max,
            initial_dropout, self.dropout_min, self.dropout_max
        )
    ...
    def increase_regularization(self):
        ...
        LOG.info(
            ...
            old_l2, self.l2_weight, old_dropout, self.dropout_rate
        )
    ...
    def reset(self, l2: Optional[float] = None, dropout: Optional[float] = None):
        """
