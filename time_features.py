...
class SafeMath:
    ...
    def safe_div(numerator: float, denominator: float, default: float = 0.0) -> float:
        ...
        """
        if abs(denominator) < 1e-10:  # Protect against near-zero
            return default
...
class TimeFeatures:
    ...
    def _clear_cache_if_stale(self, current_time: dt.datetime):
    ...
    def _validate_datetime(self, timestamp: dt.datetime) -> bool:
    ...
    def minutes_to_day_end(self, current_time: dt.datetime) -> float:
        ...
        try:
            # Next midnight UTC
            next_midnight = (current_time + dt.timedelta(days=1)).replace(
    ...
    def get_all_features(self, current_time: dt.datetime) -> Dict[str, float]:
        """
