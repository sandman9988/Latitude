...
class PathGeometry:
    ...
    def update(self, bars: deque, sigma: float) -> Dict[str, float]:
        ...
        LOG.debug("[GEOM] sigma=%.6f eff=%.4f gam_z=%.4f jerk_z=%.4f runway=%.4f feas=%.4f",
                  sigma, efficiency, gamma_z, jerk_z, runway, feasibility)
        ...
        LOG.debug(
            ...
            efficiency, gamma_z, jerk_z, runway, feasibility
        )
