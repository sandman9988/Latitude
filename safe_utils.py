...
class SafeMath:
    ...
    @staticmethod
    def is_valid(value: Union[float, int]) -> bool:
...
class SafeArray:
    ...
    @staticmethod
    def safe_get(arr: Union[List, deque], index: int, default: Any = None) -> Any:
        """
    ...
    @staticmethod
    def safe_get_series(arr: Union[List, deque], bars_ago: int, default: Any = None) -> Any:
        """
    ...
    @staticmethod
    def safe_last(arr: Union[List, deque], default: Any = None) -> Any:
        """Get last element with bounds checking"""
        return SafeArray.safe_get_series(arr, 0, default)
    
    @staticmethod
    def safe_slice(arr: Union[List, deque], start: Optional[int] = None, 
                   end: Optional[int] = None) -> Union[List, deque]:
        """
    ...
    @staticmethod
    def is_empty(arr: Union[List, deque, None]) -> bool:
...
class SafeDeque:
    ...
    def __init__(self, maxlen: Optional[int] = None, name: str = "deque"):
